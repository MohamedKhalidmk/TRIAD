...
Per the Level C guideline, this appendix contains Mohamed Khaled Abuela's original text for the Introduction, written without AI, before AI-assisted editing. AI (Claude) was also used to locate and explain sources.
